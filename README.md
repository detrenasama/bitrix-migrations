...
<tr>
    <td>Изменение настроек модулей</td>
    <td>Миграция создается, если изменены настройки модуля в админке и это значение отлично от предыдущего</td>
</tr>
</table>

* Почти все используют события `OnBefore...`. Если при вашем изменении произошла ошибка (допустим не указана привязка к сайту при добавлении инфоблока) 
